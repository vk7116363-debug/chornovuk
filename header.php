...
<section class="flash-sale-section" id="flashSale">
  ...
  <div class="flash-sale-grid">
    ...
    <div class="product-card"
      ...
      <div class="product-video">
        <img src="https://img.youtube.com/vi/GKWka9fzL8k/maxresdefault.jpg"
             onerror="this.src='https://img.youtube.com/vi/GKWka9fzL8k/hqdefault.jpg'">
        <div class="product-play"></div>
      </div>
    ...
    <div class="product-card"
      ...
      <div class="product-video">
        <img src="https://img.youtube.com/vi/oMBCpOXO5lQ/maxresdefault.jpg"
             onerror="this.src='https://img.youtube.com/vi/oMBCpOXO5lQ/hqdefault.jpg'">
        <div class="product-play"></div>
      </div>
...
(function(){
  ...
  let endDate = new Date("2026-06-21T23:59:59");
...
<!-- =============================== -->
<!--   СПЕЦПРОПОЗИЦІЯ ДЛЯ РОЗМІРУ L  -->
<!-- =============================== -->
<!-- <section class="promo-l-section">

  <div class="promo-l-box">

    <h2 class="promo-l-title">🎁 Спецпропозиція для розміру L</h2> -->

    <!-- <p class="promo-l-text">
      Маємо обмежену кількість джинсів розміру <strong>L</strong> у цій моделі.
      Тому діє спеціальна умова тільки для цього розміру.
    </p> -->

    <!-- <div class="promo-l-offer">
      🔥 При оформленні замовлення в полі коментар напишіть слово 
      <strong>"ПОДАРУНОК"</strong>
      та отримайте знижку <strong>400 грн</strong>
      <br><br>
      або придбайте джинси розміру <strong>L</strong> за спеціальною ціною 
      <strong>899 грн</strong>.
    </div>

    <div class="promo-l-note">
      *Пропозиція діє тільки для розміру L. Кількість обмежена.
    </div>
...
<style>
.promo-l-section{
  padding:8px 20px;   /* було 40px */
  margin:0px auto;    /* контрольований відступ */
  display:flex;
  justify-content:center;
}
...
.promo-l-box{
  max-width:700px;
  background:linear-gradient(135deg,#fff6f1,#ffe0d2);
  padding:24px;        /* трохи компактніше */
  border-radius:20px;
